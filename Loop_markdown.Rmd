...
```{r CSC chart, echo=FALSE, fig.cap="**The proportion of children who had been recorded as being CIN/CLA on 31st March in any given year, by offending and pupil group, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: 2.12.1]**"}
CSC_chart
```
...
```{r CIN waffle, echo=FALSE, fig.cap="**The proportion of children who had been cautioned or sentenced for a serious violence offence and had ever been CIN on 31st March in any given year, and all pupils who had ever been CIN on 31st March in any given year, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15 [Source: DfE-MoJ data share, table: 2.12.1]**"}
# set the plotting area into a 1*2 array
par(mfrow=c(1,2)) 
...
met",
                   ...
                   "A suspension is where a pupil has been temporarily removed from the school (including during lunchtime). Prior to 2019/20, a suspension was referred to as a fixed period exclusion."
