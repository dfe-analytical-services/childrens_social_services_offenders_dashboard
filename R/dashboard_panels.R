    ...
    gov_main_layout(
      gov_row(
        ...
        column(
          ...
          div(
            h1(
              tags$b("Education, children's social care and offending:"), tags$br(), tags$b("Descriptive statistics"),
              ...
              div(
                ...
                tags$div(
                  ...
                  p("This interactive dashboard was created to complement the previously published",
                    tags$a(
                      href = "https://www.gov.uk/government/publications/education-childrens-social-care-and-offending",
                  ...
                  br(),
                  tabBox(
                    width = 12, title = NULL, id = "overview_tabs",
                    tabPanel(
                      h4(tags$u("Dashboard overview")),
                      h3(tags$b("Contents")),
                      p("To navigate through the dashboard, please click on the tabs on the left (Demographics, School Experience or Children's Social Care
                        ...
                        tags$br(),
                        tags$b("2."),
                        "Either home or school LA – this selects whether the analysis focuses on the LA in which a child resides, or the LA in which a child
                                    attends school (please note that most pupils live and go to school in the same LA. However, in some cases a child's home and school LA differ)",
                        tags$br(),
                        tags$br(),
                      ...
                      p("This dashboard follows a previous national level",
                        ...
                        tags$a(
                          href = "https://www.gov.uk/government/news/support-for-vulnerable-young-people-in-serious-violence-hotspots",
                    ...
                    tabPanel(
                      h4(tags$u("Data Overview")),
                      br(),
                      details(
                        inputId = "datashare_def",
                        label = "The DfE-MoJ data-share",
                        help_text = tags$p(
                          "This section sets out details of the data share between the Ministry of Justice (MoJ) and Department for
                          ...
                          tags$a(
                            href = "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1059557/Education_children_s_social_care_and_offending_descriptive_stats_Technical_Note_FINAL.pdf",
                            "technical note"
                          ), "."
                        )
                      ),
                      details(
                        ...
                        help_text = tags$p(
                          ...
                          "This publication will present statistics relating to the local authority (LA) of a child’s school during the school year they entered when they were
                                    ...
                                    records of the LA of the child’s home address when they were aged 15.", tags$br(), tags$br(),
                          "Please see below for the year group breakdown for the all pupil cohort.",
                          tags$table(
                            border = 1, style = "font-size:16px",
                            tags$tbody(
                              tags$tr(
                      ...
                      details(
                        ...
                        help_text = tags$p(
                          tags$b("'Children who had been cautioned or sentenced for an offence'"), "relates to all children and young people
                          ...
                          tags$a(
                            href = "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1059556/Education_children_s_social_care_and_offending_descriptive_stats_FINAL.pdf",
                            "publication"
                          ), "."
                        )
                      ),
                      details(
                        ...
                        label = "Defining 'ever'",
                        help_text = tags$p(
                          "It is important to note that this analysis will not be directly comparable with other published government statistics.
                      ...
                      details(
                        ...
                        help_text = tags$p("In order to prevent the disclosure of sensitive data, any numbers in this publication that relate to less than 6 pupils have been replaced
                                                       ...
                                                       has not been conducted for City of London, Isle of Scilly and Bournemouth, Christchurch and Poole. Once more data becomes available, they may be included in future
                ...
                radioButtons("demindichoice",
                  p(
                    ...
                    tags$div(
                      class = "dropdown",
                      dropdownButton(
                        h5("Select", tags$b("Home"), "to view children who", tags$b("live"), "in given local authority.",
                          tags$br(), tags$br(),
                ...
                column(
                  ...
                  tabsetPanel(
                    ...
                    tabPanel(
                      ...
                      column(
                        width = 6, h3(textOutput("DemTitle1_FSM1"), p(tags$hr(style = "border-top: 2px solid #C1CDCD;"))),
                        plotOutput("fsmPlot1"),
                        p("Gaps in chart indicate where data has been suppressed due to small numbers, as such figures won't always sum to 100%.")
                      ),
                      column(
                        width = 6, h3(textOutput("DemTitle1_FSM2"), p(tags$hr(style = "border-top: 2px solid #C1CDCD;"))),
                        plotOutput("fsmPlot2"),
                        p("Gaps in chart indicate where data has been suppressed due to small numbers, as such figures won't always sum to 100%.")
                      )
                    )
            ...
            tabPanel(
              ...
              gov_row(
                column(
                  width = 12,
                  tabBox(
                    width = 12, title = NULL, id = "atn_subtabs",
                    tabPanel(
                      ...
                      a(
                        href = "https://www.gov.uk/government/statistics/national-curriculum-assessments-at-key-stage-2-2012-to-2013",
              ...
              gov_row(
                column(
                  ...
                  details(
                    ...
                    help_text = tags$p(
                      "A child is said to be persistently absent (PA) if they miss 10% or more of the sessions
                  ...
                  tabBox(
                    ...
                    tabPanel(
                      ...
                      a(
                        href = "https://explore-education-statistics.service.gov.uk/methodology/pupil-absence-in-schools-in-england",
                    ...
                    tabPanel(
                      ...
                      p(
                        "For the following analysis termly absence data has been used", tags$sup("[4]"),
              ...
              gov_row(
                column(
                  ...
                  details(
                    ...
                    help_text = tags$p(
                      "A suspension is where a pupil has been temporarily removed from the school",
                      tags$sup("[1] [2]"), "."
                    )
                  ),
                  details(
                  ...
                  tabBox(
                    width = 12, title = NULL, id = "SusExcl_subtabs",
                    tabPanel(
                      p(tags$u("Ever suspended/excluded")),
                      h5(tags$b("Choose plot type")),
                      tabBox(
                        width = 12, title = NULL, id = "SusExcl_subtabs2",
                        tabPanel(
                      ...
                      a(
                        href = "https://explore-education-statistics.service.gov.uk/methodology/pupil-exclusion-statistics-methodology",
                    ...
                    tabPanel(
                      ...
                      tabBox(
                        width = 12, title = NULL, id = "SusExcl_subtabs3",
                        tabPanel
                        (
              ...
              gov_row(
                column(
                  ...
                  details(
                    ...
                    help_text = tags$p(
                      "Alternative Provision (AP) is full or part-time education arranged by:", tags$br(), tags$br(),
                  ...
                  tabBox(
                    width = 12, title = NULL, id = "AP_subtabs",
                    tabPanel(
                      p(tags$u("Ever AP")),
                      h5(tags$b("Choose plot type")),
                      tabBox(
                        width = 12, title = NULL, id = "AP_subtabs2",
                        tabPanel(
                          p(tags$u("Waffle plot")),
                          column(
                            12,
            ...
            tabPanel(
              ...
              gov_row(
                column(
                  ...
                  tabBox(
                    width = 12, title = NULL, id = "sen_subtabs",
                    tabPanel(
                      p(tags$u("Ever SEN")),
                      h5(tags$b("Choose plot type")),
                      tabBox(
                        width = 12, title = NULL, id = "sen_subtab2",
                        tabPanel(
                    ...
                    tabPanel(
                      ...
                      tabBox(
                        width = 12, title = NULL, id = "sen_subtab3",
                        tabPanel(
                          p(tags$u("SEN timing")),
      ...
      gov_row(
        ...
        column(
            ...
            tabPanel(
              ...
              gov_row(
                column(
                  ...
                  h5(tags$b("Choose plot type")),
                  tabBox(
                    width = 12, title = NULL, id = "csc_subtabs",
                    tabPanel(
                      p(tags$u("Waffle plot")),
          ...
          was recorded as so in the previous 6 years. Please see here for further details:"),
              a(
                href = "https://www.gov.uk/government/publications/children-in-need-of-help-and-protection-data-and-analysis",
          ...
          coverage than those matched to later years. For example: those with KS4 academic year 2012/13 have coverage from age 8 and above."),
              ...
              br(),
              paste("10. Caution is advised when comparing across local authorities, due to differences in local policies."),
              br()
            ),
            tabPanel(
              "Timing of CSC",
