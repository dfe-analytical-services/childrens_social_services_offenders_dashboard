a11y_panel <- function() {
    tabPanel(
      ...
      br("This accessibility statement applies to the Education, children's social care and offending: local authoirty level dashboard.
...
support_links <- function() {
    ...
    "The data used to produce the dashboard along with methodological information can be found ",
    a(href = "https://www.gov.uk/government/publications/education-childrens-social-care-and-offending", "here", .noWS = c("after")),
    ".",
    br(),
    br(),
