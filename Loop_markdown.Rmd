...
writeLines(c("\\resizebox{48mm}{!}{\\includegraphics{images/Department_for_Education.png}}\n",
             ...
             "\\HUGE{\\color{dfeheadingblue}\\textbf{Education, children's social care and offending, descriptive statistics}} \n", 
...
offender_counts_school <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                                     sheet = 'No_pupils_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)

offender_counts_home <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                                   sheet = 'No_pupils_hmLA(SAFE)') %>%
  filter(HOME_LA == i)

ever_flags <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                         sheet = 'Everflag_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)

ever_flags_no_star <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                         sheet = 'Everflag_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)
...
offender_counts_school_LHS_waffle <- waffle(
  offender_counts_school_LHS, rows=10, size=0.6, 
...
offender_counts_school_RHS_waffle <- waffle(
  offender_counts_school_RHS, rows=10, size=0.6, 
...
home_vs_school <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                             sheet = 'hm_with_dif_scl(SAFE)') %>%
  filter(HOME_LA == i)

school_vs_home <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                             sheet = 'scl_with_dif_hm(SAFE)') %>%
  filter(SCHOOL_LA == i)

school_vs_home_no_star <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                             sheet = 'scl_with_dif_hm(SAFE)') %>%
  filter(SCHOOL_LA == i)

school_vs_home_no_star[school_vs_home_no_star == '*'] <- '(number too small to report)'

home_vs_school_no_star <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                             sheet = 'hm_with_dif_scl(SAFE)') %>%
  filter(HOME_LA == i)
...
previous_offending <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
gender <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
age <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
ethnic_minor <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                           sheet = 'Ethnicity_minor_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)

ethnic_major <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
ethnic_major_chart <- ggplot(ethnic_major_long, aes(x=value, y=`Ethnic Group Major`, fill = `Ethnic Group Major`)) +
  ...
  xlim(0,105) +
  scale_y_discrete(labels = c("Any other\nethnic group","Asian","Black", "Chinese", "Mixed", "Unclassified", "White")) + theme(text=element_text(size=12), #change font size of all text
        axis.text=element_text(size=12), #change font size of axis text
        axis.title=element_text(size=12), #change font size of axis titles
        plot.title=element_text(size=12), #change font size of plot title
        legend.text=element_text(size=12), #change font size of legend text
...
FSM_chart <- ggplot(FSM_for_chart, aes(x=`% eligible for FSM`, y=`Pupil Group`, fill = `Pupil Group`)) +
  ...
  xlim(0,100) + theme(text=element_text(size=12), #change font size of all text
        axis.text=element_text(size=12), #change font size of axis text
        axis.title=element_text(size=12), #change font size of axis titles
        plot.title=element_text(size=12), #change font size of plot title
        legend.text=element_text(size=12), #change font size of legend text
...
KS4_attainment <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
#KS2 chart
KS2_attainment <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
Absence_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
first_sus_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
closest_sus_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
#First exclusion chart
 first_excl_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
closest_excl_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
#AP timing
AP_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                        sheet = 'AP_timing_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)

AP_timing_no_star <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                  sheet = 'AP_timing_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)
...
SEN <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
#SEN timing charts
SEN_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                         sheet = 'SEN_timing_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)

EHCP_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
#SEMH timing
SEMH_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
...
CSC <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                  sheet = 'CiN_CLA_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)

CSC_no_star <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                  sheet = 'CiN_CLA_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)
...
CSC_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                         sheet = 'CSC_timing_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)

CSC_timing_no_star <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                         sheet = 'CSC_timing_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)

CSC_timing_no_star[CSC_timing_no_star == '*'] <- '(number too small to report)'

CLA_timing <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                         sheet = 'CLA_timing_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)

CLA_timing_no_star <- read_excel("130722_outputs_SAFE_suppressed_FINAL.xlsx", 
                         sheet = 'CLA_timing_sclLA(SAFE)') %>%
  filter(SCHOOL_LA == i)
