...
Section 2 includes analysis that relates to children's experiences during school, including:
...
The cohorts of children within this analysis include all pupils who finished key stage 2 (KS2) in 2007/08, 2008/09 or 2009/10, were aged 10 at the start of these academic years, and attended school in `r offender_counts_home$HOME_LA`. Therefore, this cohort has a key stage 4 (KS4) academic year of 2012/13, 2013/14 or 2014/15 amounting to approximately `r round(offender_counts_school$all, -2)` children. For these children, all their records from Year 1 to Year 13 (or equivalent) are included. Pupils who do not have a KS4 record are not
...
cohort_table <- data.frame(
  ...
  `KS4 Academic Year 2014-15` = c(
    "Year 13", "Year 12", "Year 11", "Year 10", "Year 9", "Year 8", "Year 7", "Year 6", "Year 5", "Year 4",
    "Year 3", "Year 2", "Year 1", "", ""
  ),
  `KS4 Academic Year 2013-14` = c(
    "", "Year 13", "Year 12", "Year 11", "Year 10", "Year 9", "Year 8", "Year 7", "Year 6", "Year 5", "Year 4",
    "Year 3", "Year 2", "Year 1", ""
  ),
  `KS4 Academic Year 2012-13` = c(
    "", "", "Year 13", "Year 12", "Year 11", "Year 10", "Year 9", "Year 8", "Year 7", "Year 6", "Year 5", "Year 4",
    "Year 3", "Year 2", "Year 1"
  ),
...
b) Children known to children's social care: Full children in need (CIN) data is available from 2011/12, term 3[^4th_footnote]. Children are included in this CIN analysis if they had been recorded as a child in need on the 31st March in any period between the ages of 12 - 16. Those matched to earlier years in the KS4 attainment data will have less coverage than those matched to later years. For example: those with KS4 academic year 2012/13 have coverage from age 14 and above. To maximise coverage of the CIN data and avoid skewed results, analysis of children in need and children who are looked after is based on children
...
The analysis has identified approximately `r round(offender_counts_school$offenders, -1)` children who had been cautioned or sentenced for an offence and attended school in `r offender_counts_school$SCHOOL_LA`, which is equivalent to `r offender_counts_school$prop_off`% of the all-pupil cohort that attended school in `r offender_counts_school$SCHOOL_LA`. In comparison, this analysis looks at approximately `r round(offender_counts_home$offenders, -1)` children who had been cautioned or sentenced for an offence lived in `r offender_counts_home$HOME_LA`, which is equivalent to `r offender_counts_home$prop_off`% of the all-pupil cohort that live in `r offender_counts_home$HOME_LA`.   
...
The analysis has identified approximately `r round(offender_counts_school$sv, -1)` children who had been cautioned or sentenced for a serious violence offence and attended school in `r offender_counts_school$SCHOOL_LA`, which is equivalent to `r offender_counts_school$prop_sv`% of the all-pupil cohort that attended school in `r offender_counts_school$SCHOOL_LA`. In comparison, this analysis looks at approximately `r round(offender_counts_home$sv, -1)` children who had been cautioned or sentenced for a serious violence offence and lived in `r offender_counts_home$HOME_LA`, which is equivalent to `r offender_counts_home$prop_sv`% of the all-pupil cohort that lived in `r offender_counts_home$HOME_LA`.   
...
offender_counts_school_for_waffle <- offender_counts_school %>%
  ...
  mutate(
    offenders_that_are_sv = round((sv / offenders) * 100, 0),
...
home_vs_school_for_chart <- home_vs_school %>%
  ...
  rename(
    `All pupils with a different school LA` = prop_count_all_dif,
...
school_vs_home_for_chart <- school_vs_home %>%
  ...
  rename(
    `All pupils with a different home LA` = prop_count_all_dif,
...
home_school_for_chart <- home_school_for_chart %>%
  mutate(value = as.numeric(value)) %>%
  mutate(
    Group = c("All Pupils", "Any Offence", "Serious Violence Offence", "All Pupils", "Any Offence", "Serious Violence Offence"),
...
In some cases, a child's home and school LA can differ. `r home_vs_school_no_star$prop_count_any_dif`% of children who had been cautioned or sentenced for an offence that had a home LA of `r home_vs_school_no_star$HOME_LA` had a different school LA (approximately `r round(home_vs_school_no_star$count_any_dif, -1)` children). `r school_vs_home_no_star$prop_count_any_dif`% that had a school LA of `r home_vs_school_no_star$HOME_LA` had a different home LA (approximately `r round(school_vs_home_no_star$count_any_dif, -1)` children).  In comparison, `r home_vs_school_no_star$prop_count_sv_dif`% of children who had been cautioned or sentenced for a serious violence offence and had a home LA of `r home_vs_school_no_star$HOME_LA` had a different school LA (approximately `r IFERROR(round(as.numeric(home_vs_school_no_star$count_sv_dif), -1))` children). `r school_vs_home_no_star$prop_count_sv_dif`% that had a school LA of `r home_vs_school_no_star$HOME_LA` had a different home LA (approximately `r IFERROR(round(as.numeric(school_vs_home_no_star$count_sv_dif), -1))` children). For the all-pupil cohort, `r home_vs_school_no_star$prop_count_all_dif`% of children that had a home LA of `r home_vs_school_no_star$HOME_LA` had a different school LA (approximately `r round(home_vs_school_no_star$count_all_dif, -1)` children). `r school_vs_home_no_star$prop_count_all_dif`% that had a school LA of `r home_vs_school_no_star$HOME_LA` had a different home LA (approximately `r round(school_vs_home_no_star$count_all_dif, -1)` children). These results are depicted in figure 2 below.
...
```{r home school chart, echo=FALSE, fig.dim = c(8, 6), fig.cap="Proportion of children with different home and school LAs. [Source: DfE-MoJ data share, table: ...]"}
home_school_chart
```
...
`r (100-previous_offending$prop_previous)`% of children who had been cautioned or sentenced for a serious violence offence and had attended school in `r offender_counts_home$HOME_LA` had not been cautioned or sentenced for a previous offence. This result was `r (significance_testing$previous_offending)` at the 5% level.  

```{r previous offending chart, echo=FALSE, fig.dim = c(8, 6), fig.cap="The proportion of children who had been cautioned or sentenced for a serious violence offence with or without a prior offence, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
...
gender_for_chart <- gender %>%
  select(
    prop_count_M, prop_any_count_M, prop_sv_count_M,
...
```{r age chart, echo=FALSE,  fig.dim = c(8, 6), fig.cap="The proportion of children relative to their age at first offence by offending group, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
age_chart
```
...
ethnic_major_long <- ethnic_major %>%
  ...
  mutate("Ethnic Group Major" = c(
    "Any other ethnic group", "Any other ethnic group", "Any other ethnic group",
    "Asian", "Asian", "Asian",
    "Black", "Black", "Black",
...
ethnic_major_long <- ethnic_major_long %>%
  map_df(rev) %>%
  mutate(
    `Ethnic Group Major` = as.factor(`Ethnic Group Major`),
...
ethnic_major_chart <- ggplot(ethnic_major_long, aes(x = value, y = `Ethnic Group Major`, fill = `Ethnic Group Major`)) +
  ...
  scale_fill_manual(
    values = c("#08306b", "#08519c", "#2171b5", "#4292c6", "#6baed6", "#9ecae1", "#c6dbef"),
...
FSM_for_waffle <- ever_flags %>%
  ...
  mutate(
    sv_prop_count_FSM = round(sv_prop_count_FSM, 0),
...
`r ever_flags_no_star$any_prop_count_FSM`% of all children who had been cautioned or sentenced for an offence and had attended school in `r home_vs_school_no_star$HOME_LA` had ever been eligible for FSM (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$any_count_FSM), -1))` children), compared to `r ever_flags_no_star$sv_prop_count_FSM`% of children who had been cautioned or sentenced for a serious violence offence and had attended school in `r home_vs_school_no_star$HOME_LA` (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$sv_count_FSM), -1))` children). This compares to `r ever_flags_no_star$prop_count_FSM`% of all pupils who attended school in `r home_vs_school_no_star$HOME_LA` and had ever been eligible for FSM (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$count_FSM), -1))` children). For children who had been cautioned or sentenced for a serious violence offence, this result was `r (significance_testing$FSM)` at the 5% level.  

```{r FSM chart, echo=FALSE,  fig.dim = c(8, 6), fig.cap="Proportion of all pupils eligible for free school meals (FSM) by offending and pupil group, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
FSM_chart
```
...
```{r FSM waffle, echo=FALSE,  fig.dim = c(8, 6), fig.cap="The proportion of children who had been cautioned or sentenced for a serious violence offence and had ever been eligible for free school meals (FSM), and all pupils who had ever been eligible for FSM, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15 [Source: DfE-MoJ data share, table: ...]"}
# set the plotting area into a 1*2 array
par(mfrow = c(1, 2))
...
KS4_attainment_for_chart <- KS4_attainment %>%
  select(
    propcount_anypass, propcount_5AG, propcount_5AC, propanycount_anypass, propanycount_5AG, propanycount_5AC,
...
KS4_attainment_for_chart <- t(KS4_attainment_for_chart) %>%
  as.data.frame() %>%
  mutate(
    `Pupil Group` = c("All Pupils", "All Pupils", "All Pupils", "Any Offence", "Any Offence", "Any Offence", "Serious Violence Offence", "Serious Violence Offence", "Serious Violence Offence"),
    KS4_benchmark = c(
...
KS4_attainment_chart <- ggplot(KS4_attainment_for_chart, aes(fill = `Pupil Group`, y = `% at\nKS4\nbenchmark`, x = KS4_benchmark2)) +
  geom_bar(position = "dodge", stat = "identity") +
  geom_text(aes(label = paste0(`% at\nKS4\nbenchmark`, "%")), vjust = -0.4, hjust = 0.5, position = position_dodge(width = 1)) +
  theme_classic() +
  theme(
...
```{r KS2 attainment chart,  fig.dim = c(8, 6), echo=FALSE, fig.cap="Proportion of all pupils who achieved level 4 or above in English and Mathematics at key stage 2 (KS2) by offending and pupil group, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
...
```{r KS4 attainment chart,  fig.dim = c(8, 6), echo=FALSE, fig.cap="Proportion of all pupils who achieved various key stage 4 (KS4) benchmarks by offending and pupil group, for pupils matched to KS4 academic year 2014/15 only. [Source: DfE-MoJ data share, table: ...]"}
...
Absence_timing_for_chart <- t(Absence_timing_for_chart) %>%
  as.data.frame() %>%
  mutate(Absence_type = factor(c(
    "Persistent absence", "Persistent absence", "Persistent absence",
    "Persistent absence (unauthorised other)", "Persistent absence (unauthorised other)",
    "Persistent absence (unauthorised other)"
  ), levels = c("Persistent absence (unauthorised other)", "Persistent absence"))) %>%
  mutate(Timing = c(
    "2 - In the same term as the first serious violence offence", "1 - Before the first serious violence offence",
...
PA_for_waffle <- ever_flags %>%
  ...
  mutate(
    sv_prop_count_PA = round(sv_prop_count_PA, 0),
...
`r ever_flags_no_star$any_prop_count_PA`% of children who had been cautioned or sentenced for an offence and had attended school in `r offender_counts_school$SCHOOL_LA` had ever been persistently absent (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$any_count_PA), -1))` children), compared to `r ever_flags_no_star$sv_prop_count_PA`% of children who had been
cautioned or sentenced for a serious violence offence (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$sv_count_PA), -1))` children). This compares to `r ever_flags_no_star$prop_count_PA`% of the all-pupil cohort that had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$count_PA), -1))`. For children who had been cautioned or sentenced for a serious violence offence, this result was `r (significance_testing$PA)` at the 5% level.  

\newpage

```{r Absence chart, echo=FALSE,  fig.dim = c(8, 6), fig.cap="Proportion of all pupils who had ever been persistently absent or persistently absent (unauthorised other) by offending and pupil group, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
Absence_chart
```
...
```{r PA waffle, echo=FALSE,  fig.dim = c(8, 6), fig.cap="The proportion of children who had been cautioned or sentenced for a serious violence offence and had been persistently absent, and all pupils who had ever been persistently absent, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15 [Source: DfE-MoJ data share, table: ...]"}
# set the plotting area into a 1*2 array
par(mfrow = c(1, 2))
...
```{r Absence timing chart, echo=FALSE, fig.dim = c(8, 6), fig.cap="Timing of first record of persistent absence or persistent absence (unauthorised other) relative to the timing of children's first serious violence offence, for all pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
...
first_sus_timing_for_chart <- first_sus_timing %>%
  ...
  mutate(grouped_overall2 = c(
    "I - 1 - 29 days", "G - 1 - 29 days", "J - 30 - 59 days", "F - 30 - 59 days", "K - 60 - 89 days",
...
first_sus_timing_for_chart <- first_sus_timing_for_chart %>% mutate(
...
closest_sus_timing_for_chart <- closest_sus_timing_for_chart %>% mutate(
  value = as.numeric(value),
  time_group = c(
    "Before", "Before", "Before", "Before", "Before", "Before", "Before",
    "Same", "After", "After", "After", "After", "After", "After", "After"
...
first_excl_timing_for_chart <- first_excl_timing_for_chart %>% mutate(
  value = as.numeric(value),
  time_group = c(
    "Before", "Before", "Before", "Before", "Before", "Before", "Before",
    "Same", "After", "After", "After", "After", "After", "After", "After"
...
closest_excl_timing_for_chart <- closest_excl_timing_for_chart %>% mutate(
  value = as.numeric(value),
  time_group = c(
    "Before", "Before", "Before", "Before", "Before", "Before", "Before",
    "Same", "After", "After", "After", "After", "After", "After", "After"
...
Excl_for_waffle <- ever_flags %>%
  ...
  mutate(
    sv_prop_count_Excl = round(sv_prop_count_Excl, 0),
...
Excl_LHS_waffle <- waffle(Excl_LHS,
  rows = 10, size = 0.6,
  colors = c("#08306b", "#2171b5"),
  title = "Children who were cautioned\nor sentenced for a\nserious violence offence",
  xlab = "1 square = 1 %"
...
Excl_RHS_waffle <- waffle(Excl_RHS,
  rows = 10, size = 0.6,
  colors = c("#08306b", "#6BACE6"),
  title = "All pupils who were\npermanently excluded",
  xlab = "1 square = 1 %"
...
Sus_for_waffle <- ever_flags %>%
  ...
  mutate(
    sv_prop_count_Sus = round(sv_prop_count_Sus, 0),
...
`r ever_flags_no_star$any_prop_count_Sus`% of all children who had been cautioned or sentenced for an offence and had attended school in `r offender_counts_school$SCHOOL_LA` had ever received a suspension (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$any_count_Sus), -1))` children), compared to `r ever_flags_no_star$sv_prop_count_Sus`% of children who had been cautioned or sentenced for a serious violence offence (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$sv_count_Sus), -1))` children). This compares to `r ever_flags_no_star$prop_count_Sus`% of the all-pupil cohort that had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$count_Sus), -1))` children).  For children who had been cautioned or sentenced for a serious violence offence, this result was `r (significance_testing$suspensions)` at the 5% level.  

Overall, `r ever_flags_no_star$any_prop_count_Excl`% of children who had been cautioned or sentenced for an offence and had attended school in `r offender_counts_school$SCHOOL_LA` had been permanently excluded (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$any_count_Excl), -1))` children), compared with `r ever_flags_no_star$sv_prop_count_Excl`% of children who had been cautioned or sentenced for a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$sv_count_Excl), -1))` children). This compares to `r ever_flags_no_star$prop_count_Excl`% of the all-pupil cohort that had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r IFERROR(round(as.numeric(ever_flags_no_star$count_Excl), -1))` children).  For children who had been cautioned or sentenced for a serious violence offence, this result was `r (significance_testing$exclusions)` at the 5% level. 

```{r ExclSus chart, echo=FALSE,  fig.dim = c(8, 6), fig.cap="The proportion of all pupils who had a record of being suspended or permanently excluded by offending and pupil group, for all pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
ExclSus_chart
```
...
```{r Sus waffle, echo=FALSE, fig.dim = c(8, 6),fig.cap="The proportion of children who had been cautioned or sentenced for a serious violence offence and had ever been suspended, and all pupils who had ever been suspended, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15 [Source: DfE-MoJ data share, table: ...]"}
# set the plotting area into a 1*2 array
par(mfrow = c(1, 2))
...
```{r Excl waffle, echo=FALSE, fig.dim = c(8, 6), fig.cap="The proportion of children who had been cautioned or sentenced for a serious violence offence and had ever been permanently excluded, and all pupils who had ever been permanently excluded, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15 [Source: DfE-MoJ data share, table: ...]"}
# set the plotting area into a 1*2 array
par(mfrow = c(1, 2))
...
```{r first_sus chart, echo=FALSE, fig.dim = c(8, 6), fig.cap="Timing of children's first suspension relative to their first serious violence offence, for all pupils matched to KS4 academic years 2012/13, 2013/14, 2014/15. [Source: DfE-MoJ data share, table: ...]"}
...
```{r closest_sus chart, echo=FALSE,  fig.dim = c(8, 6), fig.cap="Timing of children's closest suspension relative to their first serious violence offence, for all pupils matched to KS4 academic years 2012/13, 2013/14, 2014/15. [Source: DfE-MoJ data share, table: ...]"}
...
```{r closest_excl chart, echo=FALSE,  fig.dim = c(8, 6), eval=offender_counts_home$HOME_LA == 'Birmingham', fig.cap="Timing of children's closest permanent exclusion relative to their first serious violence offence, for all pupils matched to KS4 academic years 2012/13, 2013/14, 2014/15. [Source: DfE-MoJ data share, table: ...]"}
...
AP_timing_for_chart <- AP_timing_for_chart %>% mutate(
  `% with AP timing` = as.numeric(`% with AP timing`),
...
AP_for_waffle <- ever_flags %>%
  ...
  mutate(
    sv_prop_count_AP = round(sv_prop_count_AP, 0),
...
`r ever_flags_no_star$any_prop_count_AP`% of all children who had been cautioned or sentenced for an offence and had attended school in `r offender_counts_school$SCHOOL_LA` had ever been registered at an AP setting (approximately `r round(ever_flags_no_star$any_count_AP, -1)` children), compared to `r ever_flags_no_star$sv_prop_count_AP`% of children who had been cautioned or sentenced for a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r round(ever_flags_no_star$sv_count_AP, -1)` children). This compares to only `r ever_flags_no_star$prop_count_AP`% of the all-pupil cohort in `r offender_counts_school$SCHOOL_LA` (approximately `r round(ever_flags_no_star$count_AP, -1)` children). For children who had been cautioned or sentenced for a serious violence offence, this result was `r (significance_testing$AP)` at the 5% level.  

```{r AP chart, echo=FALSE,  fig.dim = c(8, 6), fig.cap="The proportion of all pupils who had ever attended alternative provision by offending and pupil group, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
AP_chart
```
...
```{r AP waffle, echo=FALSE,  fig.dim = c(8, 6), fig.cap="The proportion of children who had been cautioned or sentenced for a serious violence offence and had ever attended alternative provision, and all pupils who had ever attended alternative provision, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15 [Source: DfE-MoJ data share, table: ...]"}
# set the plotting area into a 1*2 array
par(mfrow = c(1, 2))
...
```{r AP timing chart, echo=FALSE,  fig.dim = c(8, 6), eval=NA %!in% AP_timing_for_chart$`% with AP timing`, fig.cap="The first term children attended alternative provision (AP) relative to the timing of their first offence, for all pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
AP_timing_chart
```
...
SEN_for_chart <- SEN %>%
  ...
  mutate(
    prop_NoSEN_all = 100 - prop_EHCP_all - prop_SEN_support_all, prop_NoSEN_any = 100 - prop_EHCP_any - prop_SEN_support_any,
...
SEN_timing_for_chart <- SEN_timing_for_chart %>% mutate(
  `% with timing` = as.numeric(`% with timing`),
  pupil_group = c("Serious Violence Offence", "Serious Violence Offence", "Serious Violence Offence")
)
...
EHCP_timing_for_chart <- EHCP_timing_for_chart %>% mutate(
  `% with timing` = as.numeric(`% with timing`),
  pupil_group = c("Serious Violence Offence", "Serious Violence Offence", "Serious Violence Offence")
)
...
SEN_support_for_waffle <- SEN %>%
  ...
  mutate(
    prop_SEN_support_SV = round(prop_SEN_support_SV, 0),
...
SEN_support_LHS_waffle <- waffle(SEN_support_LHS,
  rows = 10, size = 0.6,
  colors = c("#08306b", "#2171b5"),
  title = "Children who were cautioned\nor sentenced for a\nserious violence offence",
  xlab = "1 square = 1 %"
...
SEN_support_RHS_waffle <- waffle(SEN_support_RHS,
  rows = 10, size = 0.6,
  colors = c("#08306b", "#6BACE6"),
  title = "All pupils who had ever\nhad SEN support",
  xlab = "1 square = 1 %"
...
EHCP_for_waffle <- SEN %>%
  ...
  mutate(
    prop_EHCP_SV = round(prop_EHCP_SV, 0),
...
EHCP_LHS_waffle <- waffle(EHCP_LHS,
  rows = 10, size = 0.6,
  colors = c("#08306b", "#2171b5"),
  title = "Children who were cautioned\nor sentenced for a\nserious violence offence",
  xlab = "1 square = 1 %"
...
EHCP_RHS_waffle <- waffle(EHCP_RHS,
  rows = 10, size = 0.6,
  colors = c("#08306b", "#6BACE6"),
...
SEMH_timing_for_chart <- SEMH_timing_for_chart %>% mutate(
  `% with SEMH timing` = as.numeric(`% with SEMH timing`),
  pupil_group = c("Serious Violence Offence", "Serious Violence Offence", "Serious Violence Offence")
)
...
Children who had been cautioned or sentenced for an offence or a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA` were more likely to be recorded as having SEN (either with SEN support and with an EHC plan) than the all-pupil cohort that had attended school in `r offender_counts_school$SCHOOL_LA`.   

Of children who had been cautioned or sentenced for an offence and had attended school in `r offender_counts_school$SCHOOL_LA`, `r SEN$prop_SEN_any`% had ever had SEN (approximately `r IFERROR(round(as.numeric(SEN$SEN_any), -1))` children), compared to `r SEN$prop_SEN_SV`% of children who had been cautioned or sentenced for a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r IFERROR(round(as.numeric(SEN$SEN_SV), -1))` children). The corresponding proportion is lower for the all-pupil cohort in `r offender_counts_school$SCHOOL_LA`, at `r SEN$prop_SEN_all`%, which is approximately `r IFERROR(round(as.numeric(SEN$SEN_all), -1))` children. For children who had been cautioned or sentenced for a serious violence offence, this result was `r (significance_testing$SEN)` at the 5% level.   

Of children who had been cautioned or sentenced for any offence and had attended school in `r offender_counts_school$SCHOOL_LA`, `r SEN$prop_EHCP_any`% had ever had an EHC plan (approximately `r round(SEN$EHCP_any, -1)` children), compared to `r SEN$prop_EHCP_SV`% of children who had been cautioned or sentenced for a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r round(SEN$EHCP_SV, -1)` children). The corresponding proportion of the all-pupil cohort that had attended school in `r offender_counts_school$SCHOOL_LA` with an EHC plan is lower at `r SEN$prop_EHCP_all`%, which is approximately `r round(SEN$EHCP_all, -1)` children. For children who had been cautioned or sentenced for a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA`, this result was `r (significance_testing$EHCP)` at the 5% level.  

Of children who had been cautioned or sentenced for any offence and had attended school in `r offender_counts_school$SCHOOL_LA`, `r SEN$prop_SEN_support_any`% had ever had SEN support (approximately `r IFERROR(round(as.numeric(SEN$SEN_Support_any), -1))` children), compared to `r SEN$prop_SEN_support_SV`% of children who had been cautioned or sentenced for a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r round(SEN$SEN_support_SV, -1)` children). The corresponding proportion of the all-pupil cohort that had attended school in `r offender_counts_school$SCHOOL_LA` with SEN support is lower at `r SEN$prop_SEN_support_all`%, which is approximately `r round(SEN$SEN_support_all, -1)` children.  

\newpage

```{r SEN chart, echo=FALSE,fig.dim = c(8, 6), fig.cap="Special Educational Needs (SEN) of all pupils by offending and pupil group, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
SEN_chart
```

\newpage  

`r SEN$prop_SEN_support_SV`% of children who had been cautioned or sentenced for a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA` had ever had SEN support (without an EHC plan)[^26th_footnote], however only `r SEN$prop_also_SEN_support_SV`% of children who had ever had SEN support and had attended school in `r offender_counts_school$SCHOOL_LA` were children who were cautioned or sentenced for a serious violence offence.  

[^26th_footnote]:  The analysis throughout this publication refers to children with SEN support as children that had ever been identified as SEN, but never with an EHC plan.  

```{r SEN support waffle, echo=FALSE, fig.dim = c(8, 6), fig.cap="The proportion of children who had been cautioned or sentenced for a serious violence offence and had ever had SEN support, and all pupils who had ever had SEN support, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15 [Source: DfE-MoJ data share, table: ...]"}
# set the plotting area into a 1*2 array
par(mfrow = c(1, 2))
# Use grid.arrange to put plots in columns
...
```{r EHCP waffle, echo=FALSE, fig.dim = c(8, 6), fig.cap="The proportion of children who had been cautioned or sentenced for a serious violence offence and had ever had an EHC plan, and all pupils who had ever had an EHC plan, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15 [Source: DfE-MoJ data share, table: ...]"}
# set the plotting area into a 1*2 array
par(mfrow = c(1, 2))
# Use grid.arrange to put plots in columns
...
Another SEN type of interest is Speech and Language Communication needs (SLCN). `r SLCN_any$perc_SEN_type`% of children who had been cautioned or sentenced for an offence and had attended school in `r SEN$SCHOOL_LA` were recorded with SLCN, compared to `r SLCN_SV$perc_SEN_type`% of
...
```{r EHCP timing chart, echo=FALSE, fig.dim = c(8, 6), eval=NA %!in% EHCP_timing_for_chart$`% with timing`, fig.cap="The first term children had an EHC plan, relative to the timing of their first serious violence offence, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
EHCP_timing_chart
```

`r if(NA %in% EHCP_timing_for_chart$'% with timing'){"*Chart has been suppressed due to small numbers.*"}`

For children who had been cautioned or sentenced for a serious violence offence, attended school in `r offender_counts_school$SCHOOL_LA`, and had ever been recorded with SEN (either with or without an EHCP), `r SEN_timing$prop_SEN_Before_SV`% were first recorded with SEN before their first serious violence offence. 

```{r SEN timing chart, echo=FALSE, fig.dim = c(8, 6), eval=NA %!in% SEN_timing_for_chart$`% with timing`, fig.cap="The first term children had been recorded with SEN, relative to the timing of their first serious violence offence, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
SEN_timing_chart
```
...
As SEMH is consistently the most common recorded SEN type amongst children who had been cautioned or sentenced for an offence and had attended school in `r offender_counts_school$SCHOOL_LA`, further analysis has been carried out on the timing of SEMH.  

For children who had been cautioned or sentenced for a serious violence offence, had attended school in `r offender_counts_school$SCHOOL_LA` and had ever been recorded with SEMH (either with or without an EHCP), `r SEMH_timing$prop_SEMH_Before_SV`% were first recorded with SEMH before their first serious violence offence.  

```{r SEMH timing chart, echo=FALSE,fig.dim = c(8, 6), eval=NA %!in% SEMH_timing_for_chart$`% with SEMH timing`, fig.cap="The first term children had SEMH, relative to the timing of their first serious violence offence, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15. [Source: DfE-MoJ data share, table: ...]"}
SEMH_timing_chart
```
...
CSC_chart <- ggplot(CSC_for_chart, aes(fill = `Pupil Group`, y = `% recorded\nas CIN/CLA`, x = rev(CSC_type))) +
  geom_bar(position = "dodge", stat = "identity") +
  geom_text(aes(label = paste0(`% recorded\nas CIN/CLA`, "%")), vjust = -0.4, hjust = 0.5, position = position_dodge(width = 1)) +
  theme_classic() +
  theme(
    legend.position = "bottom", legend.title = element_blank(), axis.text = element_text(color = "black"),
    axis.title.x = element_blank()
...
CIN_for_waffle <- CSC %>%
  ...
  mutate(
    propsv_count_CIN = round(propsv_count_CIN, 0),
...
children in need on the 31st March in any given year when aged between 12 and 16[^31st_footnote] (approximately `r round(CSC_no_star$any_count_CIN, -1)` children), compared with `r CSC_no_star$propsv_count_CIN`% of children who had been cautioned or
sentenced for a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r round(CSC_no_star$sv_count_CIN, -1)` children) and `r CSC_no_star$propcount_CIN`% of the all-pupil cohort that had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r round(CSC_no_star$count_CIN, -1)` children). For children who had been cautioned or sentenced for a serious violence offence, this result was `r (significance_testing$CIN)` at the 5% level.   
...
`r CSC_no_star$propany_count_CLA`% of children who had been cautioned or sentenced for an offence and had attended school in `r offender_counts_school$SCHOOL_LA` were CLA on the 31st March in any given year when aged between 6 and 16[^32nd_footnote] (approximately `r CSC_no_star$any_count_CLA` children),
compared with `r CSC_no_star$propsv_count_CLA`% of children who had been cautioned or sentenced for a serious violence offence and had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r CSC_no_star$sv_count_CLA` children). This compares to `r CSC_no_star$propcount_CLA`% of the all-pupil cohort that had attended school in `r offender_counts_school$SCHOOL_LA` (approximately `r CSC_no_star$count_CLA` children). For children who had been cautioned or sentenced for a serious violence offence in `r offender_counts_school$SCHOOL_LA`, this result was `r (significance_testing$CLA)` at the 5% level.  
...
```{r CIN waffle, echo=FALSE, fig.dim = c(8, 6), fig.cap="The proportion of children who had been cautioned or sentenced for a serious violence offence and had ever been CIN on 31st March in any given year, and all pupils who had ever been CIN on 31st March in any given year, for pupils matched to KS4 academic years 2012/13, 2013/14 and 2014/15 [Source: DfE-MoJ data share, table: ...]"}
# set the plotting area into a 1*2 array
par(mfrow = c(1, 2))
...
me",
    "A suspension is where a pupil has been temporarily removed from the school (including during lunchtime). Prior to 2019/20, suspensions were referred to as a fixed period exclusion. Please see here for more information: [Exclusion from maintained schools, academies and pupil referral units in England](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1092493/20170831_Exclusion_Stat_guidance.pdf)"
  ),
  stringsAsFactors = FALSE
)
